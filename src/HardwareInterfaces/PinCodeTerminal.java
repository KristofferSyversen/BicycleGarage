...
public interface PinCodeTerminal {
	/*
	 * Register bicycle garage manager so that the pin code terminal knows which
	 * manager to call when a user has pressed a key.
	 */

	public void register(BicycleGarageManager manager);

	/*
	 * Turn on LED for lightTime seconds. Colour: colour = RED_LED = 0 => red
